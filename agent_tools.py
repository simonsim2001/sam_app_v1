...
Commune : Brides-les-Bains (73057)
...
Cordialement,"""
    ...
    # Official Email for Urbanism in Brides-les-Bains
    email = "autorisation-urbanisme@mairie-brideslesbains.fr"

    return status, request_text, email
